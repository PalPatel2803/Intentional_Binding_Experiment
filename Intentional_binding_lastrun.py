...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/palpatel/Desktop/Intentional_binding_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='Report the delay between the key press and the beep sound (0-1000); Click Submit after entering the value',
    font='Open Sans',
...
trials = data.TrialHandler(nReps=9.0, method='random', 
    ...
    trialList=data.importConditions('Intentional_binding_conditions.xlsx'),
